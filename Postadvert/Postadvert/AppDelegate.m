...
{
    NSLog(@"URL1 %@", url);
    [[NSUserDefaults standardUserDefaults] setURL:url forKey:@"openURL"];
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    {
        _viewController =  [[SideBarViewController alloc] initWithNibName:@"SideBarViewController_IPad" bundle:nil];
    }
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Postadvert" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Postadvert.sqlite"];
