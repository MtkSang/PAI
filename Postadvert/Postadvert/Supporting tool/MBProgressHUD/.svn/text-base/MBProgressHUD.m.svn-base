...
- (void)updateIndicators {
    ...
    if (!hasBackground) {
        //[(UIActivityIndicatorView*)self.indicator setActivityIndicatorViewStyle:UIActivityIndicatorViewStyleGray];
        [(UIActivityIndicatorView*)self.indicator setColor:[UIColor grayColor]];
    }
}
...
- (void)drawRect:(CGRect)rect {
	...
	CGContextSetGrayFillColor(context, 0.50f, self.opacity);
