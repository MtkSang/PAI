//
//  UILabel+RectForLetter.m
//  Postadvert
//
//  Created by Ray on 8/20/12.
//  Copyright (c) 2012 Futureworkz. All rights reserved.
//

#import "UILabel+RectForLetter.h"

@implementation UILabel (RectForLetter)
...
- (CGRect)rectForMore
{
    ...
    int index = self.text.length - 4;
    NSString *letter = [self.text substringWithRange:NSMakeRange(index, 4)];
